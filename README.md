...
- an adapter package such as `selecto_db_postgresql >= 0.4.3 and < 0.5.0`
- `selecto_mix >= 0.4.4 and < 0.5.0` if you want generators and installation helpers
...
def deps do
  [
    {:selecto_components, ">= 0.4.7 and < 0.5.0"},
    {:selecto, ">= 0.4.5 and < 0.5.0"},
    {:selecto_db_postgresql, ">= 0.4.3 and < 0.5.0"},
    {:selecto_mix, ">= 0.4.4 and < 0.5.0"}
  ]
end
```
